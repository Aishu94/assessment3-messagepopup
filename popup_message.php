<?php
/*
  Plugin Name: Message Popup
  Plugin URI: https://aishwaryad.sgedu.site/wordpress/
  Description: Welcome guests with popup message window. The message can be customized according to requirement.
  Version:1
  Author: Aishwarya Dongare
  Author URI: https://aishwaryad.sgedu.site/wordpress/
  License: GPLv2
 */
